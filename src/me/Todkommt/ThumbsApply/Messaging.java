...
private static ChatColor color = ChatColor.YELLOW;
	...
	public static List<JoinMessage> joinMessages = new ArrayList<JoinMessage>();
	...
	public static String localize(String key)
	{
		...
		{
			String msg = ThumbsApply.instance.localizationConfig.getString("messages." + key);
			return msg;
		}
		else return key;
	}
	...
	{
		for(JoinMessage msg : joinMessages)
		{
			send(sender, color + msg.message, msg.module);
		}
	}
